...
This is like medicine, used to help treat the symptoms. It is barely anything... but at least it is something.

## Change Environments

These scripts are designed to be run on the device to change the environments.
